        ...
        <div className="drop-shadow-xl bg-white w-[43vw] border-2 rounded-[12px] p-3 h-[55vh] flex flex-col">
            ...
            <section className="flex flex-row gap-2 pb-3 rounded-[12px] ">
                <div className="bg-gray-200 rounded-[10px] flex flex-col w-[25vw] p-6">
                    ...
                    <h2 className="text-2xl font-bold flex items-center gap-3"><FontAwesomeIcon icon={faUser} size="xs" color="red"/><span>{datos.turnAttended}</span></h2>
                </div> 
                <div className="bg-gray-200 rounded-[10px] flex flex-col w-[25vw] p-6">
                    <h6 className="text-gray-500">Turnos sin asistir</h6>
                    <h2 className="text-2xl font-bold flex items-center gap-3"><FontAwesomeIcon icon={faUser} size="xs" color="#0078b4"/><span>{datos.turnUnAttended}</span></h2>
                </div>
            </section>
