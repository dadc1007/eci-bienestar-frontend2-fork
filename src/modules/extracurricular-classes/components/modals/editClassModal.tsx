...
const EditClassModal: React.FC<EditClassModalProps> = ({ isOpen, onClose, onSuccess, classData }) => {
  const { updateExistingClass, loading, error, success, reset } = useUpdateClass();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const updatedClass: Class = {
      ...
      repetition: formData.repetition || null,
      instructorId: formData.instructorId || null
    };
    
    const result = await updateExistingClass(updatedClass);
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="Editar Clase">
