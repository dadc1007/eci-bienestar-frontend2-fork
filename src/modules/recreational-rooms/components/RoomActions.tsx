...
const RoomActions: React.FC = () => {
	...
	const ActionButton: React.FC<ActionButtonProps> = ({
		...
		<div className="relative group mx-4">
			...
			<div
				className="absolute left-0 top-full mt-2 w-64 p-2 bg-gray-800 text-white text-xs rounded shadow-lg
			...
			<div className="flex-1 overflow-y-auto px-6 md:px-16 py-8 w-full">
				...
				<div className="mt-8 p-6 bg-white rounded-xl shadow-sm">
					...
					<p className="text-gray-600">
						Selecciona una de las opciones de arriba para gestionar las salas
						recreativas, reservas o elementos disponibles. Cada sección te
						permitirá realizar diferentes acciones administrativas relacionadas
