        ...
        {showSuccessOverlay && (
            <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
              <div className="bg-white rounded-lg shadow-lg p-6 max-w-sm w-full text-center border-t-4 border-green-600">
                ...
                <p className="text-gray-600 mb-2">Reservaste Sala CREA Juegos</p>
                <p className="text-gray-500 text-sm">{slotConfirmado}</p>
                {juegosConfirmados.length > 0 && (
                    <div className="mt-3">
                      <p className="text-green-600 font-medium">Juegos seleccionados:</p>
            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
              <div className="bg-white p-6 rounded-lg w-full max-w-md shadow-lg relative">
                ...
                <div className="text-center mb-4">
                  <p className="text-sm text-gray-500">Selecciona uno o más juegos (opcional)</p>
